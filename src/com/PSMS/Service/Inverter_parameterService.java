/** * * 
* 文件名称: Inverter_parameterService.java *
* 
* 逆变器信息管理，增删改查逆变器信息*
* 
* 版权所有: 版权所有ZTE(C)2015 *
...
public interface Inverter_parameterService {
	/** 
	*逆变器信息管理需要的操作函数*
	* @author jiaojiao.wang  
	* @date 2014-11-18 
	*/ 
	...
	boolean checkInverterNameExistById(String name, int ps_id);//校验 逆变器是否已存在于电站中
	...
	List<Inverter_parameter> getInverterByPsandname(int ps_id,
				String inverter_name);//根据电站名称和设备名称查询逆变器信息
