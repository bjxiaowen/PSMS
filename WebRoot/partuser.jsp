...
<body>
    <p style="font-weight:bold;color:#3399cc">用户管理->用户查看</p>  
    <table id="dg" title="用户列表" class="easyui-datagrid" style="width:100%;height:95%;text-align:center" 
            url="getUserPartInformation.action?user_name=<%=username%>"        
    ...
    <div id="toolbar">
        ...
        <input id="search_name" class="easyui-searchbox" data-options="prompt:'请输入用户名查找',searcher:doSearch" style="width:200px">
       </div>
    ...
    <div id="dlg" class="easyui-dialog" style="width:400px;height:380px;padding:10px 20px"
        ...
        <form id="fm" method="post" novalidate>
            <div class="fitem">
                <label>用户名：</label>
                <input id="user_name" name="user_name" class="easyui-textbox" ></input>
            ...
            <div class="fitem">
                <label>确认密码：</label>
                <input id="repassword" name="repassword" class="easyui-textbox" type="password" >
            ...
            <div class="fitem">
                <label>角色名称:</label>
                <select id="role_name" class="easyui-combobox" name="role_name" style="width:160px;"  editable="false" data-options="panelHeight:'auto'">
                <option value="子电站运维人员">子电站运维人员</option>
                <option value="电站查看人员">电站查看人员</option>
   			 	</select>
  	...
  	/*  function setPSbyrole(rec)
       {
        ...
        function checkUpdateUserInformation(user_name,password,repassword,role_name,ps_name,ex_user_name,ex_ps_name,ex_password,telephone){
			...
			{	var result="";
				...
				if(result == "wrong"){$.messager.confirm('警告','用户名在此电站中已存在');return false;}
