     ...
     $(document).ready(function() {  			    
  	...
  	function searchData(){
		 ...
		 $('#table_title').text(table_title);
		  $("#dg").datagrid({  
             url:"getInverterCompData.action?fromRangeDate="
    		+ fromRangeDate + "&toRangeDate=" + toRangeDate
    		+ "&ps_name="+ encodeURI(encodeURI(ps_name)),
            columns: [[            
            { field: 'ps_name',title:'电站名称', width: '20%',align:'center' },  
            { field: 'inverter_name1', title:'逆变器名称', width: '12%',align:'center'},
             { field: 'power1', title:'交流功率(V)', width: '8%',align:'center'},
             { field: 'time1', title:'时间', width: '20%',align:'center' },
            { field: 'inverter_name2', title:'逆变器名称', width: '12%',align:'center'},
             { field: 'power2', title:'交流功率(V)', width: '8%',align:'center'},
